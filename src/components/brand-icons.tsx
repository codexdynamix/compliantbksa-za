...
const WA_BUBBLE =
  "M12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413A11.815 11.815 0 0 0 12.05 0Z";
...
export function WhatsAppBadge({ size = 36, className }: { size?: number; className?: string }) {
  return (
    <svg
      ...
      focusable="false"
    >
      <path fill="#25D366" d={WA_BUBBLE} />
      <path fill="#FFFFFF" d={WA_PHONE} />
    </svg>
  );
}
